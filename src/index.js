...
function setFrequencyListeners() {
  var frequencies = document.querySelectorAll(
...
function updatePaymentMethods() {
  ...
  if (eft_field) {
    var selected_frequency = document.querySelector(
...
function photoCredit() {
  ...
  if (responsiveHeroImage && responsiveHeroImage.hasAttribute("title")) {
    ...
    bgImage.insertAdjacentHTML(
      "beforeend",
      `<div class="photoCredit">${photoAttribute}</div>`
    );
    responsiveHero.insertAdjacentHTML(
      "beforeend",
      `<div class="photoCredit">${photoAttribute}</div>`
    );
  }
